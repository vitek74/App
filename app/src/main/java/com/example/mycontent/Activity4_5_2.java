...
public class Activity4_5_2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity4_5_2);

        // Получите текст с HTML-тегами из ресурсов
        String largeTextWithRecipe = getString(R.string.your_large_text_with_recipe_4_5_2);
